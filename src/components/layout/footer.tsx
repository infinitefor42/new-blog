...
export function Footer() {
  ...
  const { visitors, views, mounted } = useSiteStats();
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center text-sm text-ink-gray/60 dark:text-rice-white-dim/60">
            ...
            <p className="text-xs text-ink-gray/40 dark:text-rice-white-dim/40 mb-2 tracking-wide">
              {mounted
                ? `👤 访客 ${visitors.toLocaleString()}  ·  👁️ 浏览 ${views.toLocaleString()}`
                : "👤 访客 —  ·  👁️ 浏览 —"}
            </p>
